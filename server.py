...
def get_sectors():
    ...
    kr_sector_map = [
        ...
        ("바이오/헬스", "🧬", [("207940.KS","삼성바이오"),("068270.KS","셀트리온"),("128940.KS","한미약품"),("000100.KS","유한양행"),("170900.KS","동아에스티"),("185750.KS","종근당"),("069620.KS","대웅제약"),("006280.KS","녹십자"),("326030.KS","SK바이오팜"),("302440.KS","SK바이오사이언스")]),
